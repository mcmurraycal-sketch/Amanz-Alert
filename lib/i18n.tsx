...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "feed.cta_report": "Report one in your area",
    "feed.cta_history": "See historical reliability",
  ...
  xh: {
    ...
    "feed.cta_report": "Xela enye kwindawo yakho",
    "feed.cta_history": "Bona imbali yokuthembeka",
  ...
  af: {
    ...
    "feed.cta_report": "Rapporteer een in jou area",
    "feed.cta_history": "Sien historiese betroubaarheid",
  ...
  zu: {
    ...
    "feed.cta_report": "Bika okukodwa endaweni yakho",
    "feed.cta_history": "Buka umlando wokwethembeka",
