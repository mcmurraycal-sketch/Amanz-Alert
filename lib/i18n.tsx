...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "report.search_placeholder": "Type a suburb, street, or landmark…",
    "report.search_selected": "Location set",
    "report.step1": "Step 1 — Find the area",
    "report.step1_hint": "Search a nearby suburb, street, or landmark to centre the map.",
  ...
  xh: {
    ...
    "report.search_placeholder": "Bhala ilokishi, isitalato, okanye indawo eyaziwayo…",
    "report.search_selected": "Indawo ikhethiwe",
    "report.step1": "Inyathelo 1 — Fumana indawo",
    "report.step1_hint":
      "Khangela ilokishi, isitalato, okanye indawo eyaziwayo kufutshane ukuze imephu ihambele apho.",
